package com.mediatama.appsatipadang.user.laporan.sarana
...
import com.mediatama.appsatipadang.admin.ui.pelaporan.ActivityPelaporanAdmin
import com.mediatama.appsatipadang.data.Resource
import com.mediatama.appsatipadang.data.local.UserLocal
import com.mediatama.appsatipadang.databinding.ActivitySaranaBinding
...
import com.mediatama.appsatipadang.user.ui.pemberitahuan.ActivityPemberitahuan.Companion.ID_LAPORAN_PEMBERITAHUAN
import com.mediatama.appsatipadang.utils.Constant.bitmapToFile
import com.mediatama.appsatipadang.utils.Constant.createCustomTempFile
import com.mediatama.appsatipadang.utils.Constant.getRotatedBitmap
import com.mediatama.appsatipadang.utils.Constant.getToken
import com.mediatama.appsatipadang.utils.Constant.reduceFileImage
import com.mediatama.appsatipadang.utils.Constant.setInputError
import com.mediatama.appsatipadang.utils.Constant.uriToFile
...
//            }
            ...
            imgBack.setOnClickListener {
                viewModel.getUser().observe(this@SaranaActivity){
                    when (it.roles) {
                        "Supervisor" -> {
                            val intent = Intent(this@SaranaActivity, ActivityPelaporanAdmin::class.java)
                            startActivity(intent)
                        }
                        "Teknisi" -> {
                            val intent = Intent(this@SaranaActivity, ActivityTeknik::class.java)
                            startActivity(intent)
                        }
                        "Pelapor" -> {
                            val intent = Intent(this@SaranaActivity, MainActivity::class.java)
                            ...
                            val intent = Intent(this@SaranaActivity, ActivitySupervisor::class.java)
                            startActivity(intent)
                        }
                    }
                }
